...
<body>
	...
	<!-- 2.查询 -->
	<form:form id="searchForm" method="post" action="${ctx}/qc/abnormalProcess" modelAttribute="abnormalProcess" class="breadcrumb form-search">
		...
		<div class="controls">
			...
			<input id="PutExcel" type="submit" value="导出EXCEL" class="btn btn-primary" onclick="tableToExcel('contentTable','abnormalProcessList')"/>
		</div>
	</form:form>
